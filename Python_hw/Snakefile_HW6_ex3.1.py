...
@workflow.rule(name='all', lineno=5, snakefile='/home/aleksandar/snakemake_tutorial/examples/example_03/Snakefile')
...
def __rule_all(input, output, params, wildcards, threads, resources, log, version, rule, conda_env, container_img, singularity_args, use_singularity, env_modules, bench_record, jobid, is_shell, bench_iteration, cleanup_scripts, shadow_dir, edit_notebook):
	pass
@workflow.rule(name='align', lineno=16, snakefile='/home/aleksandar/snakemake_tutorial/examples/example_03/Snakefile')
...
@workflow.rule(name='call_peaks', lineno=29, snakefile='/home/aleksandar/snakemake_tutorial/examples/example_03/Snakefile')
...
def __rule_call_peaks(input, output, params, wildcards, threads, resources, log, version, rule, conda_env, container_img, singularity_args, use_singularity, env_modules, bench_record, jobid, is_shell, bench_iteration, cleanup_scripts, shadow_dir, edit_notebook):
	script ( "scripts/call_peaks.py" , '/home/aleksandar/snakemake_tutorial/examples/example_03' , input, output, params, wildcards, threads, resources, log, config, rule, conda_env, container_img, singularity_args, env_modules, bench_record, jobid, bench_iteration, cleanup_scripts, shadow_dir
) 


@workflow.rule(name='plot', lineno=45, snakefile='/home/aleksandar/snakemake_tutorial/examples/example_03/Snakefile')
